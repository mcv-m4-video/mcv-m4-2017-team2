...
for i = 1:nfiles
    ...
    % We have the double files than real frames, for we have the results of
    % two tests. In order to avoid making a video with double length, we
    % consider only those images of test A:
    if(file_class == 'A')
